...
const Header = effect_1.Schema.Struct({
    value: effect_1.Schema.String.pipe(effect_1.Schema.optionalWith({ nullable: true })),
});
const AppInstantiation = effect_1.Schema.Struct({
    options: effect_1.Schema.Record({ key: effect_1.Schema.String, value: effect_1.Schema.Unknown }),
});
const CellDef = effect_1.Schema.Struct({
    code: effect_1.Schema.String,
    name: effect_1.Schema.String.pipe(effect_1.Schema.optionalWith({ nullable: true }), effect_1.Schema.withDecodingDefault(() => "_")),
    options: effect_1.Schema.Record({ key: effect_1.Schema.String, value: effect_1.Schema.Unknown }),
});
const Violation = effect_1.Schema.Struct({
    description: effect_1.Schema.String,
    lineno: effect_1.Schema.Int.pipe(effect_1.Schema.optionalWith({ nullable: true }), effect_1.Schema.withDecodingDefault(() => 0)),
    col_offset: effect_1.Schema.Int.pipe(effect_1.Schema.optionalWith({ nullable: true }), effect_1.Schema.withDecodingDefault(() => 0)),
});
/**
...
exports.SemVerFromString = effect_1.Schema.transformOrFail(effect_1.Schema.String, effect_1.Schema.Struct({
    ...
    decode: (from) => {
        ...
        return effect_1.ParseResult.fail(new effect_1.ParseResult.Type(effect_1.Schema.String.ast, from, `Invalid semver string: ${from}`));
    },
