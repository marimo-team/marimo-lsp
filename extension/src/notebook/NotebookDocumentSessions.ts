            ...
            Effect.gen(function* () {
              ...
              const result = yield* SubscriptionRef.modify(
                ...
                (
                  ...
                  // Controller selection and the document lifecycle use
                  // independent VS Code events. Reject a document that closed
                  // while its candidate scope was being allocated.
