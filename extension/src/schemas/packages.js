...
exports.DependencyTreeResponse =
  exports.ListPackagesResponse =
  exports.DependencyTreeNode =
  exports.PackageDescription =
    void 0;
...
exports.DependencyTreeNode = effect_1.Schema.Struct({
  ...
  tags: effect_1.Schema.Array(
    effect_1.Schema.Record({
      key: effect_1.Schema.String,
      value: effect_1.Schema.String,
    }),
  ),
  dependencies: effect_1.Schema.Array(
    effect_1.Schema.suspend(() => exports.DependencyTreeNode),
  ),
});
/**
