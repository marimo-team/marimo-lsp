...
exports.encodeCellMetadata = exports.decodeCellMetadata = exports.CellMetadata = exports.CellLanguage = exports.CellState = void 0;
 ...
 */
exports.CellState = effect_1.Schema.Literal("idle", "queued", "running", "stale");
/**
 * Cell language
 */
 ...
 */
exports.CellMetadata = effect_1.Schema.partial(effect_1.Schema.Struct({
    // Cell execution state
    ...
    languageMetadata: effect_1.Schema.partial(effect_1.Schema.Struct({
        sql: SQLMetadata,
 ...
 */
exports.decodeCellMetadata = effect_1.Schema.decodeUnknownOption(exports.CellMetadata);
/**
